...
/*    private var taskTop: MutableList< TaskData > = mutableListOf()
    ...
    var taskGroupEditor: GlDataListEditor< TaskData > =
        GlDataListEditor(systemConfig, PATH_SYSTEM_TASK_GROUP_TOP_LEVEL) { TaskData.factory() }
